...
namespace MSBeverageRecordApp
{
    ...
    public partial class CrudWindow : Page
    {
        ...
        private void DataGridRow_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            txbPurchaseDate.SelectedDate = Reports.purchase_date;
        ...
        private void btnSaveChange_Click(object sender, RoutedEventArgs e)
        {
            ...
            for (int i = 0; i < deserializeObject.Items.Count; i++)
            {
                ...
                if (deserializeObject.Items[i].record_id == Reports.record_id)
                {
                    ...
                    post.purchase_date = txbPurchaseDate.SelectedDate.Value;
                    ...
                    deserializeObject.Items[i].purchase_date = txbPurchaseDate.SelectedDate.Value;
